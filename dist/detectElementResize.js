...
var myWindow = window;
var attachEvent = myDocument.attachEvent;
...
var requestFrame = (function () {
    var raf = window.requestAnimationFrame || myWindow.mozRequestAnimationFrame || window.webkitRequestAnimationFrame ||
        function (fn) {
...
var cancelFrame = (function () {
    var cancel = window.cancelAnimationFrame || myWindow.mozCancelAnimationFrame || window.webkitCancelAnimationFrame ||
        window.clearTimeout;
    return function (id) {
        return cancel(id);
    };
...
if (!attachEvent) {
    ...
    var domPrefixes = 'Webkit Moz O ms'.split(' '), startEvents = 'webkitAnimationStart animationstart oAnimationStart MSAnimationStart'.split(' ');
    var animation = false, animationstring = 'animation', keyframeprefix = '', pfx = '';
