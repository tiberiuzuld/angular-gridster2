...
describe('check content class for event', () => {
  ...
  it('should check when ignoreContent is true and target & currentTarget is same', () => {
    const gridster: any = {$options: {draggable: {ignoreContent: true, dragHandleClass: 'class1', ignoreContentClass: 'class2'}}};
  ...
  it('should check when ignoreContent is true but target and currentTarget is not same', () => {
    const gridster: any = {$options: {draggable: {ignoreContent: true, dragHandleClass: 'divClass', ignoreContentClass: 'class2'}}};
  ...
  it('should check when draghandleClass is false but ignoreContentClass is true', () => {
    const gridster: any = {$options: {draggable: {ignoreContent: false, dragHandleClass: 'divClass1', ignoreContentClass: 'body'}}};
